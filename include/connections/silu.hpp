...
namespace synaptic
{
    namespace connections
    {
        ...
        class silu : public basic_op<type>
        {
        public:

            silu(devices dev = devices::none, type slope_param = type(1)) : device(dev), slope_param(slope_param) {}
            silu(type slope_param) : device(devices::none), slope_param(slope_param) {}
...
#include "../src/connections/silu.tpp"
