...
namespace synaptic
{
    ...
    class tensor_reshape : public basic_op<type>
    {
    public:
        explicit tensor_reshape(devices dev = devices::none,std::vector<int> new_shape={-1}) : device(dev), new_shape(new_shape) {}
...
#include "../src/operands/tensor_reshape.tpp"
